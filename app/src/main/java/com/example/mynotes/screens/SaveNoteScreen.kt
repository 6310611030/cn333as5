    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        ContentTextField(
            ...
            onTextChange = { newContent ->
                onNoteChange.invoke(note.copy(mobile = newContent))
            }
        )
        ...
        ContentTextField(
            ...
            text = note.home,
            onTextChange = { newContent ->
                onNoteChange.invoke(note.copy(home = newContent))
            }
        )
        ...
        ContentTextField(
            ...
            text = note.work,
            onTextChange = { newContent ->
                onNoteChange.invoke(note.copy(work = newContent))
            }
        )
        ...
        ContentTextField(
            ...
            text = note.etc,
            onTextChange = { newContent ->
                onNoteChange.invoke(note.copy(etc = newContent))
            }
        )
